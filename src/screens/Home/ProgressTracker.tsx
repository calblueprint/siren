...
const ProgressTracker = (props: TrackerProps) => {
    ...
    return (
        <MainContainer>
            <View style={{ height: 193, width: 346 }}>
                <TitleContainer><TextBold>{setType(type)}</TextBold></TitleContainer>
                <TrackerContainer>
                    <ProgressSteps
                    ...
                    >
                        <ProgressStep label="Intake     submitted" removeBtnRow={true} scrollable={false}>
                            <View style={{ alignItems: 'center' }}>
                                <TextRegular>Your intake form has been submitted for this case type.</TextRegular>
                            </View>
                        </ProgressStep>
                        <ProgressStep label="Upload            docs" removeBtnRow={true} scrollable={false}>
                            <View style={{ alignItems: 'center' }}>
                                <TextRegular>Please upload your legal documents for your case to be properly assessed.</TextRegular>
                            </View>
                        </ProgressStep>
                        <ProgressStep label="Under           review" removeBtnRow={true} scrollable={false}>
                            <View style={{ alignItems: 'center' }}>
                                <TextRegular>Your case is under review.</TextRegular>
                            </View>
                        </ProgressStep>
                        <ProgressStep label="Case        approved" removeBtnRow={true} scrollable={false}>
                            <View style={{ alignItems: 'center' }}>
                                <TextRegular>Your case has been approved!</TextRegular>
                            </View>
                        </ProgressStep>
                        <ProgressStep label="Appt       scheduled" removeBtnRow={true} scrollable={false}>
                            <View style={{ alignItems: 'center' }}>
